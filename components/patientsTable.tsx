                ...
                <th className="px-4 py-3 text-left align-top relative">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      aria-label="Toggle pet type filter"
                      aria-expanded={showFilter}
                      aria-controls="pet-type-filter-panel"
                    >
                  ...
                  {showFilter && (
                    <div
                      id="pet-type-filter-panel"
                      className="absolute left-0 top-full mt-2 w-48 bg-white border border-gray-200 
